...
export default function AlternativeCard({ alternative }: AlternativeCardProps) {
  ...
  return (
    <motion.div
      ...
      className="bg-white dark:bg-gray-800 rounded-xl p-6 border-2 border-gray-200 dark:border-gray-700 hover:border-cyan-300 dark:hover:border-cyan-700 transition-all shadow-md"
    >
      ...
      <div className="flex flex-wrap gap-2">
        {alternative.affiliateLinks.map((link, idx) => (
          <a
            ...
            className="bg-gray-200 dark:bg-gray-700 hover:bg-cyan-500 hover:text-white dark:hover:bg-cyan-600 text-gray-700 dark:text-gray-300 font-semibold py-2 px-4 rounded-lg transition-all text-sm"
          >
            Ver na {link.store}
          </a>
        ))}
